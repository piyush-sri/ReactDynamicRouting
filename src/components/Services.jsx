...
const Services = () => {
  return <div className="w-1/2 m-auto mt-10 bg-zinc-100">
  <h1 className="text-grey-400 text-5xl mb-4">Services</h1>
  <p className="mb-2">
  ...
  <button className="px-3 py-1 bg-sky-500 text-sm text-white rounded-md">
    Explore More
  </button>
</div>
};
